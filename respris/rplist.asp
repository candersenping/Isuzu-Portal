...
<%Checklogin%>
	...
	<Center>
	<%
	WriteHeader "Isuzu Online: Reservedelspriser", "Reservedelspriser"
	...
	For Each objFileItem in objFolderContents
		If UCase(Right(objFileItem.Name,3)) = "PDF" or UCase(Right(objFileItem.Name,3)) = "CSV" or UCase(Right(objFileItem.Name,4)) = "XLSX" then
	%>
		<TR>
