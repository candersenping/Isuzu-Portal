...
<%Checklogin%>
	...
	<Center>
	<%
	WriteHeader "Isuzu Online: ISUZU SPPM Reklamationshåndbog", "ISUZU SPPM Reklamationshåndbog"
	...
	For Each objFileItem in objFolderContents
		If UCase(Right(objFileItem.Name,3)) = "PDF" or UCase(Right(objFileItem.Name,3)) = "DOC" or UCase(Right(objFileItem.Name,3)) = "XLS" then
	%>
		<TR>
