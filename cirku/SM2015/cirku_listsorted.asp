...
<%Checklogin%>
	...
	<%
	WriteHeader "Isuzu Online: Cirkulærer", "Cirkulærer Salg & Marketing"
	...
	<%For i = 1 to list_antal%>
		<TR>
			<TD align="left"   class="<%WriteTD(0)%>"><A HREF="<%=list_files(list_max)%>" target="_blank"><%=list_files(list_max)%></TD>
