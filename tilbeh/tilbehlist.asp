...
<%Checklogin%>
	...
	<Center>
	<%
	WriteHeader "Isuzu Online: Reservedele & Tilbehør Prislister", "Reservedele & Tilbehør Prislister"
	...
	For Each objFileItem in objFolderContents
		If UCase(Right(objFileItem.Name,3)) = "PDF" or UCase(Right(objFileItem.Name,3)) = "CSV" or UCase(Right(objFileItem.Name,3)) = "XLS" then
	%>
		<TR>
