...
<%Checklogin%>
	...
	<Center>
	<%
	WriteHeader "Isuzu Online: Træningsvideoer", "Træningsvideoer"
	...
	For Each objFileItem in objFolderContents
		If UCase(Right(objFileItem.Name,3)) = "PDF" or UCase(Right(objFileItem.Name,3)) = "DOC" or UCase(Right(objFileItem.Name,3)) = "MP4" then
	%>
		<TR>
